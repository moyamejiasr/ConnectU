...
public class NotificationsMiniAdapter extends RecyclerView.Adapter<NotificationsMiniAdapter.ViewHolder> {
    ...
    public NotificationsMiniAdapter(Context context, OnItemClickListener listener, List<String> myDataset) {
        values = myDataset;
