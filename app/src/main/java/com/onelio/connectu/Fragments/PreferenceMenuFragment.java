...
public class PreferenceMenuFragment extends PreferenceFragmentCompat {
  ...
  public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
    ...
    String type = "release";
    if (AppManager.isDebug()) type = "debug";
  ...
  Preference.OnPreferenceClickListener onFastmodeClick =
  ...
  private void setYearAdapters() {
    ...
    if (app.academicYears == null) return;
  ...
  Preference.OnPreferenceClickListener onNotificationsOpen =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
  ...
  Preference.OnPreferenceClickListener onTySRequest =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
          ...
          alert.setMessage(
              getString(R.string.app_name), Html.fromHtml(getString(R.string.disclaimer)));
  ...
  Preference.OnPreferenceClickListener onLogout =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
  ...
  Preference.OnPreferenceClickListener onStaticYear =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
  ...
  Preference.OnPreferenceClickListener onAbout =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
  ...
  Preference.OnPreferenceClickListener onTheme =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
  ...
  Preference.OnPreferenceClickListener onTheme1 =
      new Preference.OnPreferenceClickListener() {
        @Override
        public boolean onPreferenceClick(Preference preference) {
