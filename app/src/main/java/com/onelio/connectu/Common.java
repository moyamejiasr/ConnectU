...
public class Common {
  /**
   * Project developed by Onelio This project has been developed by Onelio and don't offer any
   * warranty of any type. If you want to copy this software please refer to this github repository
   * as the original in your app
   */
  ...
  /**
   * Caution with the update time, it's set at 45 min at default but more likely will be updated to
   * 1-2 hours in nexts updates as requested by the university
   */
