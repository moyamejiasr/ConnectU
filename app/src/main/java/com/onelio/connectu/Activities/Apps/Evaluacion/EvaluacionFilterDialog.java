...
public class EvaluacionFilterDialog extends Dialog {
  ...
  private void setAdapters() {
    ...
    List<String> orden =
        new ArrayList<>(
            Arrays.asList(activity.getResources().getStringArray(R.array.type_filters)));
  ...
  private void setDefaultData() {
    ...
    sp_sign
        .getBackground()
        .setColorFilter(
            getContext().getResources().getColor(R.color.black_overlay), PorterDuff.Mode.SRC_ATOP);
    sp_sign.setOnItemSelectedListener(
    ...
    sp_order
        ...
        .setColorFilter(
            getContext().getResources().getColor(R.color.black_overlay), PorterDuff.Mode.SRC_ATOP);
    sp_order.setOnItemSelectedListener(
        new AdapterView.OnItemSelectedListener() {
          public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
