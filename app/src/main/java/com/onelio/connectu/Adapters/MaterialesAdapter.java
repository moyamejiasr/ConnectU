...
public class MaterialesAdapter extends RecyclerView.Adapter<MaterialesAdapter.ViewHolder> {
  ...
  public MaterialesAdapter(
      Context context, OnItemClickListener listener, List<MaterialData> myDataset) {
    files = myDataset;
  ...
  public void onBindViewHolder(final ViewHolder holder, final int position) {
    ...
    if (!material.isFolder()) {
      ...
      holder.autor.setText(
          context.getString(R.string.materiales_by)
              + " "
              + AppManager.capAfterSpace(material.getPublisherName()));
    } else {
