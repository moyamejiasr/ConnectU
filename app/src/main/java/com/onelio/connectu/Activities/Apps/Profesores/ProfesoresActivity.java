...
public class ProfesoresActivity extends AppCompatActivity {
    ...
    private void updateYear(int year) {
        ...
        this.year = year;
        title.setText(getString(R.string.title_activity_profesores) + " (" + app.academicYears.get(year).getYear() + ")");
        subjectId = "";
        setSubjectsAdapter();
        loadProfesores();
    }
    ...
    ProfesoresAdapter.OnItemClickListener onClick = new ProfesoresAdapter.OnItemClickListener() {
        @Override
