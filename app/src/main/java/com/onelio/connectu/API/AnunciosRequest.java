...
public class AnunciosRequest {
  ...
  // Private definitions
  private static String MARCAR_TODOS_LEIDO =
      "https://cvnet.cpd.ua.es/uaAnuncios/Anuncios/MarcarTodosLeido";
  private static String MARCAR_LEIDO = "https://cvnet.cpd.ua.es/uaAnuncios/Anuncios/MarcarLeido";
  private static String MARCAR_NO_LEIDO =
      "https://cvnet.cpd.ua.es/uaAnuncios/Anuncios/MarcarNoLeido";
  private static String ANUNCIOS_URL = "https://cvnet.cpd.ua.es/uaanuncios/";
  private static String ANUNCIO_URL =
      "https://cvnet.cpd.ua.es/uaanuncios/anuncios/anuncio?idanuncio=";
          ...
          public void onNavigationComplete(boolean isSuccessful, String body) {
            if (isSuccessful) {
              ...
              try {
                ...
                FirebaseCrash.report(e);
                callback.onResult(
                    false, ErrorManager.LOGIN_REJECTED); // Usually because session ended!
              }
            } else {
              callback.onResult(false, body);
            }
