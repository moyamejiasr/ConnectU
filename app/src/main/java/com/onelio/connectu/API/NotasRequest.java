...
public class NotasRequest {
  ...
  private static String NOTAS_FETCH_URL =
      "https://cvnet.cpd.ua.es/uaEvalua/misnotas/DashBoardAsignatura/";
  // Private content
  // Session
  ...
  private NotaData parseObject(JSONObject jobject) {
    ...
    try {
      long date =
          Long.valueOf(AppManager.before(AppManager.after(jobject.getString("FECHA"), "("), ")"));
