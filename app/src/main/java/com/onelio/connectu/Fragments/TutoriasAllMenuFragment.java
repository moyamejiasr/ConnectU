...
public class TutoriasAllMenuFragment extends Fragment {
  ...
  public TutoriasAllMenuFragment() {
              ...
              getActivity()
                  .runOnUiThread(
                      new Runnable() {
                        ...
                        public void run() {
                          if (onResult) {
                            List<TutoriaData> stutorias =
                                request.parseTutorias(false, message, subject);
  ...
  TutoriasAdapter.OnItemClickListener onClick =
      new TutoriasAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(int item) {
          ...
          intent.putExtra(
              Common.TUTORIAS_STRING_AUTHOR_IMG, tutorias.get(item).getTeacherPicture());
