...
public class App extends Application {
  public static String name = "ConnectU";
  ...
  public JSONObject loadJUser() {
    ...
    if (isLogged) {
      ...
      } // If content is wrong or empty create new
  ...
  public boolean loadUser() {
    ...
    if (isLogged) {
      ...
      } //  TODO If content is wrong or empty create new
  ...
  public void logoutUser(final Activity activity) {
    ...
    alert.setMessage(
        activity.getString(R.string.app_name), activity.getString(R.string.alert_logout));
