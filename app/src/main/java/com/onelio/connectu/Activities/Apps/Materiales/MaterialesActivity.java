...
public class MaterialesActivity extends AppCompatActivity {
    ...
    request.loginService(
        new MaterialesRequest.MaterialsCallback() {
          ...
          public void onResult(final boolean onResult, final String message) {
            MaterialesActivity.this.runOnUiThread(
                new Runnable() {
                  @Override
                  public void run() {
                    if (onResult) {
  ...
  private void updateYear(boolean isFirst, final int year) {
    ...
    title.setText(
        getString(R.string.title_activity_materiales)
            + " ("
  ...
  private void setupViewPager(ViewPager viewPager) {
    ...
    adapter.addFrag(
        new MaterialesAllMenuFragment(), getString(R.string.title_fragment_files_recent));
