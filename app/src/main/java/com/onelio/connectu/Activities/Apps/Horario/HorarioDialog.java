...
public class HorarioDialog extends Dialog {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (rloc.isEmpty()) rloc = event.getLoc();

    String instant = TimeParserHelper.getDifference(getContext(), event.getStart(), event.getEnd());
    String content =
        getContext().getString(R.string.view_horario_last)
            + " "
            + instant
            + "\n"
            + getContext().getString(R.string.view_horario_loc)
            + ": "
            + rloc;
                                ...
                                try {
                                  String uri =
                                      String.format(
                                          Locale.ENGLISH,
                                          "geo:%f,%f?z=21",
                                          Double.valueOf(object.getString("lat")),
                                          Double.valueOf(object.getString("lon")));
                                  ...
                                  if (intent.resolveActivity(getContext().getPackageManager())
                                    ...
                                    Toast.makeText(
                                            getContext(),
                                            getContext().getString(R.string.error_no_maps),
                                            Toast.LENGTH_SHORT)
                                        .show();
                                  }
                                  ...
                                  Toast.makeText(
                                          getContext(),
                                          getContext().getString(R.string.error_external_app),
                                          Toast.LENGTH_SHORT)
                                      .show();
                                }
                              }
