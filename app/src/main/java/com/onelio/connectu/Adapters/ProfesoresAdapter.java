...
public class ProfesoresAdapter extends RecyclerView.Adapter<ProfesoresAdapter.ViewHolder> {
  ...
  @Override
  public ProfesoresAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    //  create a new view
      ...
      if (aLoc <= position) {
        ...
        if (position - 1 < 0) {
          ...
          if (position + 1 < data.size()
              && teacher.getSubject().equals(data.get(position + 1).getSubject())) {
