...
public class HomeMenuFragment extends Fragment {
                            ...
                            public void run() {
                              ...
                              if (onSuccess) {
                                ...
                                if (!error.handleError(message)) {
                                  ...
                                  Toast.makeText(
                                          getContext(),
                                          getString(R.string.error_unkown_response_format),
                                          Toast.LENGTH_SHORT)
                                      .show();
                                }
                              }
  ...
  private void loadMiniNotifications() {
    ...
    notiMAdapter =
        new NotificationsMiniAdapter(getContext(), onNotificationMiniClick, notificationsMini);
  ...
  private void loadReminders() {
    ...
    List<CalendarEvent> events =
        request.getDateEvent(
            new Date(), Common.SCHEDULE_FILTER_EXAMS + Common.SCHEDULE_FILTER_EVALUACION);
  ...
  private void loadNotifications() {
    ...
    while (keys.hasNext()) {
      ...
      if (!key.equals("count")) {
        ...
        getFragmentManager()
            .beginTransaction()
            .add(fragment.getId(), intent, null)
            .commitAllowingStateLoss(); // commitAllowingStateLoss insteaf of commit to fix a bug
  ...
  NotificationsMiniAdapter.OnItemClickListener onNotificationMiniClick =
      new NotificationsMiniAdapter.OnItemClickListener() {
        @Override
  ...
  ReminderAdapter.OnItemClickListener onReminderClick =
      new ReminderAdapter.OnItemClickListener() {
        @Override
  ...
  TimeLineAdapter.OnItemClickListener onTimeLineClick =
      new TimeLineAdapter.OnItemClickListener() {
        @Override
        public void onItemClick(int item, CalendarEvent event) {
          HorarioDialog dialog = new HorarioDialog(getActivity(), event);
          dialog.show();
