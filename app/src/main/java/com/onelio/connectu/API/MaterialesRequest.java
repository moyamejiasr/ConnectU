...
public class MaterialesRequest {
  ...
  private static String MATERIALES_FIRST_DATE_CHANGE =
      "https://cvnet.cpd.ua.es/uamatdocente/Materiales/AsignaturasMateriales";
  private static String MATERIALES_DATE_CHANGE =
      "https://cvnet.cpd.ua.es/uamatdocente/Materiales/CambiarCursoAlu";
  private static String MATERIALES_UNSEEN =
      "https://cvnet.cpd.ua.es/uamatdocente/Materiales/AsignaturasMateriales";
  private static String MATERIALES_ALL =
      "https://cvnet.cpd.ua.es/uamatdocente/Materiales/CursoMaterialesTodos";
  ...
  private MaterialData parseElement(Element element) {
    ...
    if (element.hasClass("carpeta")) {
      ...
      String typeName =
          element.select("div.columna4 > span.imagentipo > span.glyphs").attr("title");
  ...
  public void downloadFile(MaterialData data, final File file, final MaterialsCallback callback) {
    String url =
        "https://cvnet.cpd.ua.es/uamatdocente/Materiales/File?idMat="
            + data.getId()
            + "&tipoorigen="
            + data.getType();
    UAWebService.HttpFileDownloadRequest(
        context,
        url,
        file,
        new UAWebService.WebCallBack() {
