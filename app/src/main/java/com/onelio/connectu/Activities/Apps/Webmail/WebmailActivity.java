...
public class WebmailActivity extends AppCompatActivity {
  ...
  private void startControllers() {
    webView.loadUrl(url);
    final String js =
        "javascript:document.getElementById('usuario').value = '"
            + app.account.Email
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
          ...
          new WebViewClient() {
            ...
            public void onPageFinished(WebView view, String url) {
              if (needsLogin && url.equals(WebmailActivity.this.url)) {
                if (needsLogin) needsLogin = false; // Prevent from repeating after login
      ...
      progress.setVisibility(View.INVISIBLE);
      Toast.makeText(getBaseContext(), getString(R.string.error_web_older), Toast.LENGTH_LONG)
          .show();
      webView.setVisibility(View.VISIBLE);
    }
    // Allow downloads
          ...
          public void onDownloadStart(
            ...
            if (AppManager.isStoragePermissionGranted(WebmailActivity.this)) {
              ...
              Toast.makeText(
                      ...
                      getString(R.string.message_downloading_to_d),
                      Toast.LENGTH_LONG)
                  .show();
            }
          }
