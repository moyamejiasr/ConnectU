...
public class UAWebService {
  ...
  public static void HttpWebGetRequest(
      final Context context, final String stringUrl, final WebCallBack callback) {
      ...
      client.get(
          ...
          new Callback() {
            ...
            public void onResponse(Call call, Response response) throws IOException {
              if (app.account != null
                  && app.account.isLogged
                  && !isStillLoggedIn(response, stringUrl)) {
  ...
  // Post Method
  public static void HttpWebPostRequest(
      final Context context, final String stringUrl, String json, final WebCallBack callback) {
    final App app = (App) context.getApplicationContext();
    HttpClient client =
        new HttpClient(context, true); // Finally UA fucked up their service, now it's f slow too
    try {
      client.post(
          stringUrl,
          json,
  ...
  // JSONPost Method
  public static void HttpWebJSONPostRequest(
      final Context context, final String stringUrl, String json, final WebCallBack callback) {
    final App app = (App) context.getApplicationContext();
    HttpClient client = new HttpClient(context, true);
    try {
  ...
  public static void HttpWebMultiPartPostRequest(
      final Context context, final String stringUrl, RequestBody body, final WebCallBack callback) {
    final App app = (App) context.getApplicationContext();
    HttpClient client = new HttpClient(context, true);
    try {
      client.mpost(
  ...
  //  Normal Download
  public static void HttpFileDownloadRequest(
      final Context context, final String stringUrl, final File file, final WebCallBack callback) {
    final App app = (App) context.getApplicationContext();
    HttpClient client = new HttpClient(context, true);
    file.deleteOnExit();
    try {
            ...
            public void onResponse(Call call, Response response) throws IOException {
              if (app.account != null
                ...
                callback.onNavigationComplete(
                    response.isSuccessful(), ErrorManager.FILE_DONT_EXIST);
              }
              response.close();
            }
          });
