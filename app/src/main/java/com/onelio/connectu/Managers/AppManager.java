...
public class AppManager {
  ...
  public static String capFirstLetter(String original) {
    ...
    return original.toLowerCase().substring(0, 1).toUpperCase()
        + original.toLowerCase().substring(1);
  }
  ...
  public static void addShortcutToHorario(Context context) {
    ...
    addIntent.putExtra(
        ...
        Intent.ShortcutIconResource.fromContext(context, R.drawable.ic_horario));
  ...
  public static void addShortcutToWebmail(Context context) {
    ...
    shortcutIntent.putExtra(
        Common.WEBVIEW_EXTRA_NAME, context.getString(R.string.title_webapp_email));
    ...
    addIntent.putExtra(
        Intent.EXTRA_SHORTCUT_ICON_RESOURCE,
        Intent.ShortcutIconResource.fromContext(context, R.drawable.ic_webmail));
    ...
    if (Build.VERSION.SDK_INT >= 23) {
      if (ContextCompat.checkSelfPermission(activity, Manifest.permission.WRITE_EXTERNAL_STORAGE)
        ...
        alert.setMessage(
            ...
            activity.getString(R.string.error_download_cancel));
