...
public class TutoriasRequest {
  ...
  private static String TUTORIAS_ALL_FETCH_SUBJECT =
      "https://cvnet.cpd.ua.es/uaTutorias/Emisor/FiltroListadoTutoHechasAsig";
  private static String TUTORIAS_UNSEEN_FETCH_SUBJECT =
      "https://cvnet.cpd.ua.es/uaTutorias/Emisor/FiltroListadoTutoSinLeerAsig";
  ...
  private static String TUTORIA_MARK_READ =
      "https://cvnet.cpd.ua.es/uaTutorias/Emisor/MarcarTutoLeida";
  private static String TUTORIA_MARK_UNREAD =
      "https://cvnet.cpd.ua.es/uaTutorias/Emisor/MarcarTutoNoLeida";
  ...
  private static String TUTORIAS_TEACHER_FIND =
      "https://cvnet.cpd.ua.es/uaTutorias/Emisor/GetDestinatariosmisPDI";
  // Private content
  // Session
  ...
  private String fetchJSONBy(String pDisplayCount, String pDisplay, String year, String subject) {
    String displayStart =
        String.valueOf(Integer.valueOf(pDisplayCount) * Integer.valueOf(pDisplay));
  ...
  public void teacherFind(
      String subjectId, final String teacherName, final TutoriasCallback callback) {
    String json = "{\"Cod\":\"" + subjectId + "\",\"Curso\":\"" + parseYear() + "\"}";
    UAWebService.HttpWebJSONPostRequest(
        context,
        TUTORIAS_TEACHER_FIND,
        json,
        new UAWebService.WebCallBack() {
          @Override
          public void onNavigationComplete(boolean isSuccessful, String body) {
            if (isSuccessful) {
              ...
              if (!found) callback.onResult(false, ErrorManager.TEACHER_ID_NOT_FOUND);
            } else {
  ...
  public void requestNewTutoria(
      final String subjectId, final String teacherName, final TutoriasCallback callback) {
    UAWebService.HttpWebGetRequest(
        context,
        TUTORIAS_G_MAKE,
        new UAWebService.WebCallBack() {
  ...
  public void createTutoria(
      ...
      String title,
      String text,
      final TutoriasCallback callback) {
    RequestBody requestBody =
        new MultipartBody.Builder()
            ...
            .build();
    UAWebService.HttpWebMultiPartPostRequest(
        context,
        TUTORIAS_NT,
        requestBody,
        new UAWebService.WebCallBack() {
